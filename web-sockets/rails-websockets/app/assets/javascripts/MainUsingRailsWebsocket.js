		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					...
					event.userId,
					A2(_elm_lang$core$Basics_ops['++'], ' - ', event.action)))
			]));
};
var _user$project$View$eventsView = F2(
	function (config, model) {
		...
		if (_p0.ctor === 'Connected') {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Currently connected to channel'),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[]),
						A2(_elm_lang$core$List$map, _user$project$View$eventView, model.events)),
						A2(
						_elm_lang$html$Html$button,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(config.sendMsg)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
			...
			return _elm_lang$html$Html$text('Currently disconnected from channel');
		}
	});
var _user$project$View$view = F2(
	function (config, model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_user$project$View$eventsView, config, model)
				]));
	});
var _user$project$View$Config = function (a) {
	return {sendMsg: a};
};

var _user$project$RailsWebSocket$findMatchingChannel = F2(
	function (channelName, channels) {
		...
		while (true) {
			...
			if (_p0.ctor === '[]') {
				...
				var _p1 = _p0._0;
				if (_elm_lang$core$Native_Utils.eq(_p1.name, channelName)) {
					...
					channelName = _v1;
					channels = _v2;
					continue findMatchingChannel;
				}
			}
		}
	});
var _user$project$RailsWebSocket$channelNameDecoder = A2(
...
var _user$project$RailsWebSocket$decodeMsgWithType = F3(
	function (noOp, channels, msgType) {
		var _p2 = msgType;
		switch (_p2) {
			case 'ping':
				return _elm_lang$core$Json_Decode$succeed(noOp);
			case 'confirm_subscription':
				return A2(
					_elm_lang$core$Json_Decode$andThen,
					_user$project$RailsWebSocket$channelNameDecoder,
					function (channelName) {
						var _p3 = A2(_user$project$RailsWebSocket$findMatchingChannel, channelName, channels);
						if (_p3.ctor === 'Just') {
							return _elm_lang$core$Json_Decode$succeed(_p3._0.onConnect);
						} else {
							return _elm_lang$core$Json_Decode$succeed(noOp);
						}
					});
			case 'reject_subscription':
				return A2(
					...
					_user$project$RailsWebSocket$channelNameDecoder,
					function (channelName) {
						var _p4 = A2(_user$project$RailsWebSocket$findMatchingChannel, channelName, channels);
						if (_p4.ctor === 'Just') {
							return _elm_lang$core$Json_Decode$succeed(_p4._0.onReject);
						} else {
							return _elm_lang$core$Json_Decode$succeed(noOp);
						}
					});
...
var _user$project$RailsWebSocket$messageWithTypeDecoder = F2(
	function (noOp, channels) {
		return A2(
			_elm_lang$core$Json_Decode$andThen,
			A2(_elm_lang$core$Json_Decode_ops[':='], 'type', _elm_lang$core$Json_Decode$string),
			A2(_user$project$RailsWebSocket$decodeMsgWithType, noOp, channels));
	});
var _user$project$RailsWebSocket$actualMessageDecoder = F2(
	function (noOp, channels) {
		return A2(
			_elm_lang$core$Json_Decode$andThen,
			_user$project$RailsWebSocket$channelNameDecoder,
			function (channelName) {
				var _p5 = A2(_user$project$RailsWebSocket$findMatchingChannel, channelName, channels);
				if (_p5.ctor === 'Just') {
					var _p6 = _p5._0;
					return A2(
						_elm_lang$core$Json_Decode$at,
						_elm_lang$core$Native_List.fromArray(
							['message']),
						A2(_elm_lang$core$Json_Decode$map, _p6.onMessage, _p6.messageDecoder));
				} else {
					return _elm_lang$core$Json_Decode$succeed(noOp);
				}
			});
	});
var _user$project$RailsWebSocket$messageDecoder = F2(
	function (noOp, channels) {
		return _elm_lang$core$Json_Decode$oneOf(
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_user$project$RailsWebSocket$messageWithTypeDecoder, noOp, channels),
					A2(_user$project$RailsWebSocket$actualMessageDecoder, noOp, channels)
				]));
	});
var _user$project$RailsWebSocket$channelListener = F3(
	function (noOp, channels, message) {
		return A2(
			_elm_lang$core$Result$withDefault,
			noOp,
			A2(
				_elm_lang$core$Json_Decode$decodeString,
				A2(_user$project$RailsWebSocket$messageDecoder, noOp, channels),
				message));
	});
var _user$project$RailsWebSocket$perform = F3(
	function (url, action, channel) {
		return A2(
						...
						[
							...
							_1: _elm_lang$core$Json_Encode$string(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'{\"channel\":\"',
									A2(_elm_lang$core$Basics_ops['++'], channel.name, '\"}')))
						},
							{
							ctor: '_Tuple2',
							_0: 'data',
...
var _user$project$RailsWebSocket$connect = F2(
				...
				_elm_lang$core$Json_Encode$object(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'command',
							_1: _elm_lang$core$Json_Encode$string('subscribe')
						},
							{
							ctor: '_Tuple2',
							_0: 'identifier',
...
var _user$project$RailsWebSocket$listen = F3(
	function (url, noOp, channels) {
		return A2(
			_elm_lang$websocket$WebSocket$listen,
			url,
			A2(_user$project$RailsWebSocket$channelListener, noOp, channels));
	});
var _user$project$RailsWebSocket$Channel = F5(
	function (a, b, c, d, e) {
		return {name: a, onConnect: b, onReject: c, onMessage: d, messageDecoder: e};
	});

var _user$project$MainUsingRailsWebsocket$eventDecoder = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Model$Event,
...
var _user$project$MainUsingRailsWebsocket$socketUrl = 'ws://localhost:3000/cable';
var _user$project$MainUsingRailsWebsocket$NoOp = {ctor: 'NoOp'};
var _user$project$MainUsingRailsWebsocket$SendMsg = {ctor: 'SendMsg'};
var _user$project$MainUsingRailsWebsocket$ReceivedEvent = function (a) {
	return {ctor: 'ReceivedEvent', _0: a};
};
var _user$project$MainUsingRailsWebsocket$RejectedFrom = {ctor: 'RejectedFrom'};
var _user$project$MainUsingRailsWebsocket$ConnectedTo = {ctor: 'ConnectedTo'};
var _user$project$MainUsingRailsWebsocket$channel = {name: 'AllMessagesChannel', onConnect: _user$project$MainUsingRailsWebsocket$ConnectedTo, onReject: _user$project$MainUsingRailsWebsocket$RejectedFrom, onMessage: _user$project$MainUsingRailsWebsocket$ReceivedEvent, messageDecoder: _user$project$MainUsingRailsWebsocket$eventDecoder};
var _user$project$MainUsingRailsWebsocket$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_user$project$Model$init,
	_elm_lang$core$Native_List.fromArray(
		[
			A2(_user$project$RailsWebSocket$connect, _user$project$MainUsingRailsWebsocket$socketUrl, _user$project$MainUsingRailsWebsocket$channel)
		]));
var _user$project$MainUsingRailsWebsocket$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ConnectedTo':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{status: _user$project$Model$Connected}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'RejectedFrom':
				return A2(
			...
			case 'SendMsg':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A3(_user$project$RailsWebSocket$perform, _user$project$MainUsingRailsWebsocket$socketUrl, 'sendMessage', _user$project$MainUsingRailsWebsocket$channel)
						]));
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$MainUsingRailsWebsocket$subscriptions = function (model) {
	return A3(
		_user$project$RailsWebSocket$listen,
		_user$project$MainUsingRailsWebsocket$socketUrl,
		_user$project$MainUsingRailsWebsocket$NoOp,
		_elm_lang$core$Native_List.fromArray(
			[_user$project$MainUsingRailsWebsocket$channel]));
};
var _user$project$MainUsingRailsWebsocket$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _user$project$MainUsingRailsWebsocket$init,
			update: _user$project$MainUsingRailsWebsocket$update,
			subscriptions: _user$project$MainUsingRailsWebsocket$subscriptions,
			view: _user$project$View$view(
				{sendMsg: _user$project$MainUsingRailsWebsocket$SendMsg})
		})
};

var Elm = {};
Elm['MainUsingRailsWebsocket'] = Elm['MainUsingRailsWebsocket'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['MainUsingRailsWebsocket'], 'MainUsingRailsWebsocket', typeof _user$project$MainUsingRailsWebsocket$main === 'undefined' ? null : _user$project$MainUsingRailsWebsocket$main);
