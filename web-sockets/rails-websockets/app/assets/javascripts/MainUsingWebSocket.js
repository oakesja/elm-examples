...
var _user$project$MainUsingWebSocket$socketUrl = 'ws://localhost:3000/cable';
var _user$project$MainUsingWebSocket$sendMessageToChannel = function (name) {
	return A2(
		_elm_lang$websocket$WebSocket$send,
		_user$project$MainUsingWebSocket$socketUrl,
		A2(
								...
								_elm_lang$core$Json_Encode$object(
									_elm_lang$core$Native_List.fromArray(
										[
											...
											ctor: '_Tuple2',
											_0: 'action',
											_1: _elm_lang$core$Json_Encode$string('sendMessage')
										}
										]))))
					}
					]))));
};
var _user$project$MainUsingWebSocket$connectToChannel = function (name) {
	return A2(
		_elm_lang$websocket$WebSocket$send,
		_user$project$MainUsingWebSocket$socketUrl,
		A2(
...
var _user$project$MainUsingWebSocket$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_user$project$Model$init,
	_elm_lang$core$Native_List.fromArray(
		[
			_user$project$MainUsingWebSocket$connectToChannel('AllMessagesChannel')
		]));
var _user$project$MainUsingWebSocket$SendMsg = {ctor: 'SendMsg'};
var _user$project$MainUsingWebSocket$ReceivedMessage = function (a) {
	return {ctor: 'ReceivedMessage', _0: a};
};
var _user$project$MainUsingWebSocket$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, _user$project$MainUsingWebSocket$socketUrl, _user$project$MainUsingWebSocket$ReceivedMessage);
};
var _user$project$MainUsingWebSocket$Unknown = {ctor: 'Unknown'};
var _user$project$MainUsingWebSocket$Recieved = F2(
	function (a, b) {
		return {ctor: 'Recieved', _0: a, _1: b};
	});
var _user$project$MainUsingWebSocket$ConnectedToChannel = function (a) {
	return {ctor: 'ConnectedToChannel', _0: a};
};
var _user$project$MainUsingWebSocket$Ping = {ctor: 'Ping'};
var _user$project$MainUsingWebSocket$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'ReceivedMessage') {
			var _p5 = _p0._0;
			var decodeMsg = function (msgType) {
				var _p1 = msgType;
				switch (_p1) {
					case 'ping':
						return _elm_lang$core$Json_Decode$succeed(_user$project$MainUsingWebSocket$Ping);
					case 'confirm_subscription':
						return A2(
							_elm_lang$core$Json_Decode$object1,
							_user$project$MainUsingWebSocket$ConnectedToChannel,
							A2(
					...
					default:
						return _elm_lang$core$Json_Decode$succeed(_user$project$MainUsingWebSocket$Unknown);
				}
			};
			var decoder = _elm_lang$core$Json_Decode$oneOf(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$MainUsingWebSocket$Recieved,
						A2(
							_elm_lang$core$Json_Decode$customDecoder,
							A2(_elm_lang$core$Json_Decode_ops[':='], 'identifier', _elm_lang$core$Json_Decode$string),
							_elm_lang$core$Json_Decode$decodeString(
						...
						A2(_elm_lang$core$Basics_ops['++'], 'Failed to decode: ', _p5))
					]));
			var decodedMsg = A2(
				_elm_lang$core$Result$withDefault,
				_user$project$MainUsingWebSocket$Unknown,
				A2(_elm_lang$core$Json_Decode$decodeString, decoder, _p5));
			var _p2 = decodedMsg;
			switch (_p2.ctor) {
				case 'ConnectedToChannel':
					var _p3 = _p2._0;
					if (_p3 === 'AllMessagesChannel') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$MainUsingWebSocket$sendMessageToChannel('AllMessagesChannel')
					]));
		}
	});
var _user$project$MainUsingWebSocket$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _user$project$MainUsingWebSocket$init,
			update: _user$project$MainUsingWebSocket$update,
			subscriptions: _user$project$MainUsingWebSocket$subscriptions,
			view: _user$project$View$view(
				{sendMsg: _user$project$MainUsingWebSocket$SendMsg})
		})
};

var Elm = {};
Elm['MainUsingWebSocket'] = Elm['MainUsingWebSocket'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['MainUsingWebSocket'], 'MainUsingWebSocket', typeof _user$project$MainUsingWebSocket$main === 'undefined' ? null : _user$project$MainUsingWebSocket$main);
